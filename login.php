<?php
    ...
    if( isset($_POST['login']) ){
            ...
            if(!empty(trim($username)) && !empty(trim($password))){
                ...
                $query      = "SELECT * FROM admin_berita WHERE username = '$username'";
                ...
                if ($row != 0) {
                    ...
                    if ($_SESSION["username"]=$row["username"]=='admin' AND $password==$row["password"]){
                        header("Location:admin-online/bootstrap-sidebar-main/admin-online.html");
			...
			<div class="row justify-content-sm-center h-100">
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div class="text-center my-5">
                        <img src="asset/logo-dark.png" alt="logo" width="400">
					</div>
